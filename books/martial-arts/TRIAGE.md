...
#15 to #18 here, and sargas79/GWorldVTT#193 to #196 in the system.
...
| 2. Characters: power level, 11 character templates with Cinematic and Tough Guy lenses, advantages, perks, disadvantages, skills | 28-62 | the templates; 3 advantages, 169 perks, 2 disadvantages, 7 new skills, Combat Art and Sport skills (by directive), sports specialties of Games | character and lens templates; perks; Talents with skill lists; no Art or Sport versions of combat skills | statistics (#16), templates by hand; text (#17); the chapter's rules in the journal (#18) |
...
| `[SKILLS]`, directives | `skill` | `martial-arts-skills` | the Art and Sport versions of every combat skill (p. 55) are generated by `#` directives the parser does not read; **by hand** |
...
system first**, and until then those modes are written by hand without the bonus.
Two give their damage as "spec." (the Garrote among them) and two name no hit
location; those four are written by hand (#16).
...
- **New specialties of Basic Set skills and traits, to add by hand:**
  ...
  - Hobby Skill (Feats of Strength)
  - Games for 17 sports, and Riding (Equines)
  - Philosophy (Buddhism, Dragon Temple, Taoism) and Theology (Hinduism)
  - Code of Honor (Bushido) and (Xia)
- **New techniques for skills the Basic Set's list lacks, to add by hand:**
  - Arm Lock (Tonfa)
  - Finger Lock off either Arm Lock
...
- **New weapons the Basic Set only mentions, to add by hand:** Okusarigama,
  Rokushaku Kama, Ahlspiess, Chigoridani.
