...
describe("the books' rule groups", () => {
  it("registers one group per book, named for the book, under this module", () => {
    ...
    expect(highTech.map((rule: any) => [rule.key, rule.default, rule.reference])).toEqual([["firearmQuality", false, "High-Tech p. 79"], ["gunCare", false, "High-Tech pp. 80-81, 129"], ["immediateAction", false, "High-Tech pp. 81, 249-251"], ["gunDrawing", false, "High-Tech pp. 81-82, 153-154, 249"], ["gunfightStandoff", false, "High-Tech p. 82"], ["triggerMechanisms", false, "High-Tech p. 82"], ["burstFire", false, "High-Tech pp. 82-83"], ["fastFiring", false, "High-Tech pp. 84, 251-252"], ["fanningAndThumbing", false, "High-Tech pp. 83-84, 251-252"]]);
  });
