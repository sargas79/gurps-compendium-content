...
/**
 * Armour a stunner's current runs through, and metallic armour's DR 1 against
 * it (p. 165; Campaigns p. 432): the shared contact-stunner engine's, which
 * High-Tech's stun weapons use too.
 */
export { isMetallicArmor, METALLIC_SHOCK_DR } from "../../../shared/stunners/rules.js";
