...
function itemContext(item: any): Record<string, unknown> {
  ...
  return {
    ...
    solar: design.power === "solar" ? F("SolarRecharge", { hours: solarRechargeHours(design.tl) }) : "",
    replicating: design.selfReplicating ? F("Replicating", { squareYards: design.squareYards, after: selfReplicatedSize(design.squareYards, 6) }) : "",
